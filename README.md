...
This is a PoC developed using the RAD (Rapid Application Development) method with core tge models and functionality completed in 48 hours. Because of this, there still exists some bugs.
